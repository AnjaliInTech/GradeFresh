  ...
  return (
    <div className="relative min-h-screen  bg-white">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4 py-10">
        <div className="w-full max-w-md bg-[#e0f5a1] backdrop-blur-lg p-8 rounded-3xl shadow-xl border border-[#a3d921]">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-[#036424] border-[#036424] rounded focus:ring-[#a3d921]"
                />
              ...
              <div className="text-sm">
                <Link href="/forgot-password" className="text-[#036424] hover:text-[#a3d921] transition-colors">
          ...
          <p className="text-center text-sm text-gray-800">
            ...
            <Link href="/register" className="text-[#036424] font-medium hover:underline transition-all">
              Sign up
            </Link>
          </p>
        </div>
